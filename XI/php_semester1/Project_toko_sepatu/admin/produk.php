...
<head>
	...
	<title>Kelola Produk - <?= $name ?></title>
										...
										<tbody>
											...
											?>
												...
												<tr>
													...
													<td>
														<a href="edit_produk.php?id=<?php echo $p['idproduk']; ?>" class="btn btn-warning">Edit</a>
														<a href="proses_hapus.php?idp=<?php echo $p['idproduk']; ?>" class="btn btn-danger" onclick="return confirm('Ingin hapus data ini?')">Hapus</a>
													</td>
