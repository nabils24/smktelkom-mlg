		...
		<div class="container">
			...
			<div class="col-md-8 products-right">
				<div class="agile_top_brands_grids">
					...
					// bgrs berguna untuk menampilkan data dari database yang diurutkan dari idproduk secara ascending (ASC) dan di simpan ke variabel brgs
