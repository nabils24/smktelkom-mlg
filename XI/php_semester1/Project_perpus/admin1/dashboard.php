...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            ?>
            <?php
            include 'component/sideitem_lihatdata.php';
            ?>
            <!-- Divider -->
            <hr class="sidebar-divider">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Kelas</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlahkelas?></div>
                                        </div>   
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Perhari
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Perbulan
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Pertahun
                                        </span>
                                    </div>
                                </div>
                            </div>
