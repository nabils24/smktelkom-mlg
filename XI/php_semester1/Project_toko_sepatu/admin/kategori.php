                                    ...
                                    <div class="data-tables datatable-dark">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_kategori.php?id=<?php echo $row['idkategori'] ?>">Edit</a> || <a href="
                                                    proses_hapus.php?idk=<?php echo $row['idkategori'] ?>" onclick="return confirm('Ingin hapus data ini?')">Hapus</a>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
