...
if (isset($_POST['kirim'])) {
    ...
    $updatestatus1 = mysqli_query($conn, "update detailorder set status='Pengiriman' where orderid='$orderids'");
...
if (isset($_POST['selesai'])) {
    ...
    $updatestatus1 = mysqli_query($conn, "update detailorder set status='Selesai' where orderid='$orderids'");
    if ($updatestatus) {
        echo " <div class='alert alert-success'>
...
<head>
    ...
    <title><?= $name ?> - Pesanan <?php echo $checkdb['namalengkap']; ?></title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                }else if($checkdb['status'] == 'Pengiriman'){
