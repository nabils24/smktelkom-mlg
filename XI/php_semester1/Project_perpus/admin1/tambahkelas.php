                ...
                <div class="container-fluid">
                    ...
                    <form class="user" method="POST" enctype="multipart/form-data"> 
                                ...
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="kelompok"></textarea>
                                    <label for="floatingTextarea2">Kelompok Kelas</label>
                                </div>
                                </div>
