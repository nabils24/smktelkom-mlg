                ...
                <div class="container-fluid">
                    ...
                    <form class="user" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-floating">
                                    ...
                                    <label for="floatingTextarea2" >Alamat Lengkap Siswa</label>
                                </div>
                                </div>
                                <div class="form-group">
                                        <input type="text" class="form-control" id="exampleFirstName"
                                ...
                                <div class="form-group">
                                        <input type="file" class="form-control" id="exampleFirstName"
                                            placeholder="foto siswa" name="gambar">
                                </div>
                                <div class="form-group">
                                    <select class="form-select" name="kelas" required>
                                        <option value="">--- Pilih Kelas ---</option>
                                        <?php
                                            $kategori = mysqli_query($conn, "SELECT* FROM kelas ORDER BY id_kelas DESC");
                            ...
                            <?php
                                if(isset($_POST['submit'])){
                                    ...
                                    if(!in_array($type2, $type_allowed)){
                                        ...
                                        move_uploaded_file($tmp_name, './image_siswa/'.$newname);
