...
<head>
    ...
    <title>Kelola Metode Pembayaran - <?= $name ?></title>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit_pembayaran.php?id=<?php echo $id; ?>" class="btn btn-warning">Edit</a>
                                                        <a href="proses_hapus.php?idpem=<?php echo $id; ?>" class="btn btn-danger">Hapus</a>
                                                    </td>
